...
const Color kBlueColor = Color(0xff0087FF);
const Color kLightBlueColor = Color(0xffE3F2FF);
...
const Color kOrangeColor = Color(0xffFF7D53);
const Color kLightOrangeColor = Color(0xffFFE4F2);
